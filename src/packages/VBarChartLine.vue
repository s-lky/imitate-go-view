...
const getOption = () => {
  ...
  const defaultBar = [120, 200, 150, 80, 70]
  const defaultLine = [72, 120, 90, 48, 42]
    ...
    series: [
      {
        name: '柱状图',
        type: 'bar',
        data: seriesData1.length > 0 ? seriesData1 : defaultBar,
        itemStyle: { color: '#00e5ff' }
      },
      {
        name: '折线图',
        type: 'line',
        data: seriesData2.length > 0 ? seriesData2 : defaultLine,
